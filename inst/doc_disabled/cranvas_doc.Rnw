...
Figure \ref{fig:An-example-system-linkage} shows an example system
of the linkage. 

\begin{center}
\begin{figure}[H]
\begin{centering}
\includegraphics[width=0.6\textwidth]{figure/cranvas_link_1}
\par\end{centering}

\caption{\label{fig:An-example-system-linkage}An example system of linkage.
B is the mutaframe, C and D are the reference classes, A and E are
the views, all the arrows are the listeners.}
\end{figure}
...
build two types of linkage for the problems in Figure \ref{fig:self-cross-linkage}.

\begin{center}
\begin{figure}[H]
\begin{centering}
\includegraphics[width=0.6\textwidth]{figure/cranvas_link_2}
\par\end{centering}

\caption{\label{fig:self-cross-linkage}Two types of linkage. Left: self-linkage
to the mutaframe itself. Right: cross linkage between two mutaframes.}
\end{figure}
