...
qparallel(vars=13:10, data=qnrc, main='Overview of Rankings', glyph='tick', horizontal=FALSE, boxplot=TRUE)
qnrc$.color = 'red'
...
qparallel(vars=14:19, data=qnrc, main='Research, Student Support, Diversity', center=median, horizontal=FALSE, glyph='tick')

qparallel(vars=20:68, data=qnrc, main='Other Indicators', center=median, horizontal=FALSE, glyph='tick', lab.split=NULL, boxplot=TRUE, boxwex=.8)
...
qparallel(vars=var.ord, data=qnrc, main='Other Indicators', center=median, horizontal=FALSE, glyph='tick', lab.split=NULL, boxplot=TRUE, boxwex=.8)
...
qparallel(data=qdiamonds, vars = 1:7, glyph = 'line', jitter = ~ cut + color + clarity)
