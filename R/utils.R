...
##' OR, XOR, NOT and COMPLEMENT respectively.
##'
...
##'
##' The question key (?) toggles the identify mode (on or off). In the
##' identify mode, labels generated by the identified cases will be
