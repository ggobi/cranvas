...
##'
##' See \code{\link{common_key_press}} and
##' \code{\link{common_key_release}} for common interactions in all
##' plots, and the documentation of specific plots for other possible
##' interactions.
