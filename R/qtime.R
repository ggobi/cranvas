...
qtime = function(time, y, data, group=NULL,
  ...
  if(y[1] == "c") y = y[-1]
  tdata = time_qdata(data, y, c(time,as.character(call$group)))
  b = brush(tdata)
  meta = Time.meta$new(varname = list(x = time, y = y), minor = 'xy')
  time_meta_initialize(meta, call, data=tdata, shift=shift, 
...
time_meta_initialize = function(meta, call, data,
