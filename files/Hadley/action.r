...
zoominAct <- qaction(desc = "Zoom In", shortcut = "Ctrl++", parent = view)
zoomoutAct <- qaction(desc = "Zoom Out", shortcut = "Ctrl+-", parent = view)

qaddAction(view, zoomoutAct)

qconnect(zoominAct, signal = "triggered", handler = function(x, ...) {
